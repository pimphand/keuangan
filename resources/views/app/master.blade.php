...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header bg-white text-center" style="background: #fff; !important">
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    <b class="logo-abbr"><img src="{{ asset('logo.png')}}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('logo.png') }}" alt=""></span>
                    <span class="brand-title">
                        <img src="{{ asset('logo.png')}}" alt="" style="height: 30px">
                        <span class="text-black ml-2 text-bold">PT MDT</span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <script
        src="{{ asset('asset_admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
