        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header pt-4">
                    <a href="{{ route('user.tambah') }}" class="btn btn-primary float-right"><i class="fa fa-plus"></i>
                        &nbsp TAMBAH
                        PENGGUNA</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('user.delete', ['id' => $u->id]) }}">
                                                <div class="modal fade" id="hapus_user_{{$u->id}}" tabindex="-1" role="dialog"
