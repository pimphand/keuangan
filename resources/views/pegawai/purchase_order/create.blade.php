...
@push('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const createItemRow = (preset = null) => {
                ...
                quantityInput.min = '1';
                quantityInput.value = preset && preset.quantity ? preset.quantity : '';
            ...
            if (Array.isArray(oldItems) && oldItems.length > 0) {
                oldItems.forEach(it => itemList.appendChild(createItemRow(it)));
            } else {
            ...
            form.addEventListener('submit', (e) => {
                // Build items[] inputs dynamically before submit
