...
<div class="content-body">
    <div class="row page-titles mx-0 mt-2">
        <h3 class="col p-md-0">Edit Project</h3>
        ...
        <div class="card">
            <div class="card-header pt-4">
                ...
                <div class="card-tools">
                    <a href="{{ route('project.show', $project) }}" class="btn btn-secondary btn-sm">
            ...
            <div class="card-body">
                <form action="{{ route('project.update', $project) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('brosur_id') is-invalid @enderror" name="brosur_id" id="brosur_id" required>
                                    ...
                                    @foreach($brosurs as $brosur)
                                        <option value="{{ $brosur->id }}" data-harga="{{ $brosur->harga }}" {{ $project->brosur_id == $brosur->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" name="status" id="status" required>
                                    <option value="belum bayar" {{ $project->status == 'belum bayar' ? 'selected' : '' }}>Belum Bayar</option>
                                    <option value="bayar" {{ $project->status == 'bayar' ? 'selected' : '' }}>Bayar</option>
                                    <option value="kurang" {{ $project->status == 'kurang' ? 'selected' : '' }}>Kurang</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('harga') is-invalid @enderror" 
                                       name="harga" id="harga" value="{{ old('harga', $project->harga) }}" required min="0">
                                @error('harga')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('total_bayar') is-invalid @enderror" 
                                       name="total_bayar" id="total_bayar" value="{{ old('total_bayar', $project->total_bayar) }}" required min="0">
                                @error('total_bayar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('project.show', $project) }}" class="btn btn-secondary">
